...
locals {
  azure_image_name = var.test ? "${var.image_name}-test" : var.image_name
}
...
source "azure-arm" "source" {
  ...
  capture_container_name = local.azure_image_name
  capture_name_prefix    = local.azure_image_name
